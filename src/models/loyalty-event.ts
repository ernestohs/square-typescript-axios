...
export class LoyaltyEvent {
    ...
    @Field(() => LoyaltyEventAccumulatePoints, { nullable: true })
    ...
    @Field(() => LoyaltyEventCreateReward, { nullable: true })
    ...
    @Field(() => LoyaltyEventRedeemReward, { nullable: true })
    ...
    @Field(() => LoyaltyEventDeleteReward, { nullable: true })
    ...
    @Field(() => LoyaltyEventAdjustPoints, { nullable: true })
    ...
    @Field(() => LoyaltyEventExpirePoints, { nullable: true })
    ...
    @Field(() => LoyaltyEventOther, { nullable: true })
